...
import { ArrowLeft, User, Mail, School, CreditCard, MessageSquare, StickyNote } from 'lucide-react';
...
export default function InnovatorDetailPage() {
    ...
    const handleSaveNote = () => {
        toast({ title: "Note Saved", description: "Your internal note for this innovator has been saved." });
    }
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                     <Card>
                        <CardHeader>
                           <CardTitle className="flex items-center gap-2"><StickyNote className="h-5 w-5" /> Internal Notes</CardTitle>
                           <CardDescription>Private notes about this innovator. Only visible to you.</CardDescription>
                        </CardHeader>
                        <CardContent>
                           <Textarea 
