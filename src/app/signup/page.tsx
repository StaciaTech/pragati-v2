...
import { Building, Landmark, User as UserIcon, ArrowRight, ArrowLeft } from 'lucide-react';
  ...
  const selectionOptions = [
    {
      ...
      description: 'Sign up to submit your ideas, build a team, and get AI-powered feedback.',
      href: '/signup/individual'
    },
    {
      icon: Building,
      title: 'For an Existing Institution / Org',
      description: 'Join your organization or college that is already on the PragatiAI platform.',
      href: '/signup/join-organization'
    },
    {
      icon: Landmark,
      title: 'Register a New Institution / Org',
      description: 'Onboard your entire organization or college to manage your innovation ecosystem.',
