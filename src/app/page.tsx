...
const features = [
  {
    ...
    description:
      "Receive in-depth, structured feedback on your ideas in minutes, not weeks. Our AI analyzes your concept against dozens of key viability parameters.",
  },
  {
    icon: <Rocket className="h-8 w-8 text-teal-400" />,
    title: "Guided Innovation Roadmap",
    description:
      "Don't just get a score, get a plan. PragatiAI provides a clear, step-by-step roadmap to take your idea from TRL 1 to market-ready.",
  },
  {
    icon: <Users className="h-8 w-8 text-orange-400" />,
    title: "Role-Based Dashboards",
    description:
      "Track performance, identify trends, and make data-driven decisions with dashboards tailored to every role, from innovator to administrator.",
  },
];
...
const testimonials = [
  {
    quote:
      "PragatiAI transformed my raw concept into a fundable project. The AI feedback was like having a team of expert consultants 24/7.",
    name: "Aarav Sharma",
  ...
  {
    quote:
      "As a mentor, this platform is a game-changer. I can track my students' progress, provide targeted feedback, and see real results.",
    name: "Dr. Priya Desai",
  ...
  {
    quote:
      "We've seen a 300% increase in quality idea submissions since adopting Pragati. It has revolutionized our college's innovation ecosystem.",
    name: "R. Madhavan",
...
const whoWeServe = [
  {
    ...
    icon: Landmark,
    description:
      "For colleges and universities, Pragati helps manage Technology Transfer Cells (TTCs) and nurture student and faculty ideas within your innovation ecosystem.",
  },
  {
    name: "Organisations & GCCs",
    icon: Building,
    description:
      "For corporate, government, or Global Capability Centers, Pragati provides a centralized platform to manage, mentor, and accelerate innovations at scale.",
  },
  {
    name: "Innovators",
    icon: UserIcon,
    description:
      "For the solo creator, student, or researcher, Pragati is your co-pilot, providing the expert feedback and structured guidance needed to turn a spark of an idea into reality.",
  },
];
      ...
      <header className="py-4 px-4 sm:px-6 lg:px-8 fixed top-0 left-0 w-full z-50 bg-background/70 backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <nav className="hidden lg:flex items-baseline space-x-4">
            <a
              href="#features"
              className="nav-link text-foreground/80 hover:text-primary px-3 py-2 text-sm font-medium"
            >
              Features
            </a>
            <a
        ...
        <section className="relative min-h-[calc(100dvh-4rem)] flex items-center justify-center overflow-hidden py-16 px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative z-10 max-w-4xl w-full mx-auto text-center flex flex-col items-center">
            ...
            <motion.p
              {...FADE_IN_ANIMATION_VARIANTS}
              transition={{
                ...FADE_IN_ANIMATION_VARIANTS.transition,
                delay: 0.2,
              }}
                ...
                <div className="relative">
                  <div className="absolute top-3 right-3 z-10">
                    <DropdownMenu>
                      ...
                      <DropdownMenuContent>
                        <DropdownMenuItem
                          onSelect={() => handlePresetSelect("Balanced")}
                        >
                          Balanced
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onSelect={() => handlePresetSelect("Impact-First")}
                        >
                          Impact-First
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onSelect={() => handlePresetSelect("Scale-Up")}
                        >
                          Scale-Up
                        </DropdownMenuItem>
                        <DropdownMenuItem
                          onSelect={() => handlePresetSelect("Disruptor")}
                        >
                          Disruptor
                        </DropdownMenuItem>
                      </DropdownMenuContent>
                  ...
                  <div className="absolute bottom-3 left-3 flex items-center gap-1">
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>Use AI to enhance your text (in-app feature)</p>
                        </TooltipContent>
                      </Tooltip>
                      <Tooltip>
                        <TooltipTrigger asChild>
                        ...
                        <TooltipContent>
                          <p>Attach pitch deck (in-app feature)</p>
                        </TooltipContent>
                      </Tooltip>
                    </TooltipProvider>
                  </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
                Comprehensive tools designed to transform your innovative ideas
              ...
              {whoWeServe.map((item) => (
                <motion.div
                  ...
                  animate={{
                    ...
                    y: activeTab === item.name ? 0 : 20,
                  }}
                  transition={{ duration: 0.5 }}
                  style={{
                    display: activeTab === item.name ? "block" : "none",
                  }}
                  className="card-hover bg-card p-8 rounded-2xl shadow-lg border"
                >
        ...
        <section className="py-20 bg-muted/20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p className="text-muted-foreground mb-12">
              Powering innovation ecosystems across the nation.
            </p>
            <Carousel
              opts={{
                align: "start",
        ...
        >
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto text-balance">
                See how Pragati is transforming innovation across colleges and
          ...
          <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            >
              ...
              <Button
                size="lg"
                asChild
                className="bg-white text-primary px-12 py-4 rounded-lg text-lg font-semibold hover:bg-gray-100 transform hover:scale-105 transition-all duration-300 shadow-xl"
                onClick={() => router.push("/signup")}
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 leading-relaxed">
                Transforming academic innovation into market reality through
                AI-powered validation and guidance.
              </p>
            </div>
          ...
          <div className="border-t border-gray-700 mt-12 pt-8 text-center">
            <p className="text-muted-foreground">
              © 2025 Pragati by Vencorp a Unit of{" "}
              <a
                href="https://www.staciacorp.com"
                target="_blank"
                rel="noopener noreferrer"
