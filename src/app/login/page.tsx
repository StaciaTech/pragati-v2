                ...
                {step === "select_type" && (
                  ...
                  >
                    <div className="grid grid-cols-1 gap-4">
                      <button
                        onClick={() => handleTypeSelect("organisations")}
                        className={cn(
                          "p-4 border rounded-lg cursor-pointer flex items-start gap-4 transition-all text-left hover:border-primary hover:bg-muted",
                          userType === "organisations" &&
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            For corporate or government entity users.
                          </p>
                        </div>
                      </button>
                      <button
                        onClick={() => handleTypeSelect("institutions")}
                        className={cn(
                          "p-4 border rounded-lg cursor-pointer flex items-start gap-4 transition-all text-left hover:border-primary hover:bg-muted",
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            For users affiliated with a Government & College
                            Cells.
                          </p>
                        </div>
                      </button>
                      <button
                        onClick={() => handleTypeSelect("innovator")}
                        className={cn(
                          "p-4 border rounded-lg cursor-pointer flex items-start gap-4 transition-all text-left hover:border-primary hover:bg-muted",
                          userType === "innovator" &&
                            "border-primary ring-2 ring-primary bg-muted"
                      ...
                      >
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            For independent innovators, mentors, or team
                            members.
                          </p>
                        </div>
                      </button>
